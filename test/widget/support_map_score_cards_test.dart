...
void main() {
  ...
  testWidgets(
    'SupportMapScreen shows enabled ScoreCards without combined score',
    (tester) async {
      ...
      expect(find.text('Scrolling Control'), findsOneWidget);
      expect(find.text('Anxiety Load'), findsOneWidget);
      expect(find.text('Overall'), findsNothing);
      expect(find.text('Combined'), findsNothing);
      expect(find.text('Total Score'), findsNothing);
      expect(
